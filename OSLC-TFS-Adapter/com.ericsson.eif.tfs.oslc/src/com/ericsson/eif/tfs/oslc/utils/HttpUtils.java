...
import com.ericsson.eif.tfs.oslc.Credentials;
import com.ericsson.eif.tfs.oslc.TFSAdapterManager;
import com.ericsson.eif.tfs.oslc.exception.AdapterOAuthException;
...
public class HttpUtils {
    ...
    public static void sendUnauthorizedResponse(HttpServletResponse response,
        ...
        if (e instanceof AdapterOAuthException) {
            OAuthServlet.handleException(response, e, TFSAdapterManager.REALM);
        } else {

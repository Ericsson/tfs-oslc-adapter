...
public class ServiceProviderCatalogService
{
    ...
    public ServiceProviderCatalog getServiceProviderCatalog()
    {
        ...
        if (catalog != null) {
        	...
        	httpServletResponse.addHeader(TFSAdapterConstants.HDR_OSLC_VERSION,"2.0");
        	return catalog;
        }
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId)
    {
    	...
    	if (catalog !=null )
    	{
	        ...
	        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/ericsson/eif/tfs/oslc/serviceProviderCatalog_html.jsp");
    		try {

...
import com.ericsson.eif.tfs.oslc.ServiceProviderInfo;
...
public class ServiceProviderCatalogSingleton
{
    ...
    static
    {
        try
        {
            ...
            serviceProviderCatalog.setPublisher(new Publisher("Team Foundation Server", "com.ericsson.eif.tfs.cm"));
 ...
 */
           ...
           throws URISyntaxException
    {
        synchronized(serviceProviders)
        {
            final URI serviceProviderURI = new URI(baseURI + "/projects/" + collectionId + "/" + productId);
    ...
    protected static void initServiceProviders (HttpServletRequest httpServletRequest)   
    {
		try {
	        ...
	        ServiceProviderInfo [] serviceProviderInfos = TFSAdapterManager.getServiceProviderInfos(httpServletRequest);
	        ...
	        for (ServiceProviderInfo serviceProviderInfo : serviceProviderInfos) {
				...
				String collectionId = serviceProviderInfo.collectionId;
		        if (! serviceProviders.containsKey(serviceProviderId)) {
					String serviceProviderName = serviceProviderInfo.name;
					String title = "Service provider for TFS : " + serviceProviderName + "(" + serviceProviderId + ")";
					String description = "Service provider for Team Foundation Server: " + serviceProviderName + "(" + serviceProviderId + ")";
		        	...
		        	final ServiceProvider aServiceProvider = TFSAdapterServiceProviderFactory.createServiceProvider(basePath, title, description, publisher, parameterMap);
		            registerServiceProvider(basePath,aServiceProvider,collectionId, serviceProviderId);
	        	}
	        }
		} catch (Exception e) {
			e.printStackTrace();

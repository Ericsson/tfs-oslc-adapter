...
<!-- Jazz Root Services, see:
 ...
 -->
<rdf:Description rdf:about="<%= oauthDomain + "/rootservices" %>"
	...
	<dcterms:title>OSLC-CM Adapter/TFS Jazz Root Services</dcterms:title>
	<oslc_cm:cmServiceProviders rdf:resource="<%= catalogUri %>" />
	<jd:oslcCatalogs>
		<oslc:ServiceProviderCatalog rdf:about="<%= catalogUri %>">
	 		<oslc:domain rdf:resource="http://open-services.net/ns/cm#" />
	 	</oslc:ServiceProviderCatalog>
	</jd:oslcCatalogs>
	<jfs:oauthRealmName>TFS</jfs:oauthRealmName>

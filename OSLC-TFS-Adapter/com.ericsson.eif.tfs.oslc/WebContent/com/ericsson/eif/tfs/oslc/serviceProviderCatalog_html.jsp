...
<%@ page import="com.ericsson.eif.tfs.oslc.TFSAdapterManager" %>
<%--
...
--%>
<%
String tfsUri = TFSAdapterManager.getTfsServerUrl() + "/" + 
...
<html>
	<head>
		...
		<title>TFSAdapter OSLC Adapter: Service Provider Catalog</title>
		<%-- 
Start of user code (RECOMMENDED) headStuff 
		--%>
       <link rel="shortcut icon" href="<%= tfsUri %>/images/favicon.ico">
		<%-- 
End of user code 
		--%>
	</head>
